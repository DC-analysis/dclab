...
in dclab.
The first downloadable file ("plugin_example_features.py") in this section
contains the plugin, while
the second file ("plugin_load_script.py") contains code on how to load and utilise the plugin within
dclab.
